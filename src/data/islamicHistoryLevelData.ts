export interface Level {
  ...
  export const islamicHistoryLevels: Level[] = [
    ...
    {
      id: 2,
      name: "Niveau 2 - Prophètes Majeurs",
    ...
    {
      id: 3,
      name: "Niveau 3 - Prophètes et Rois",
    ...
    {
      id: 4,
      name: "Niveau 4 - Prophète Muhammad et Califats",
      description: "Histoire complète de l'Islam selon Ibn Kathir",
      lessonCount: 8,
      color: "bg-red-500",
      lessons: [
        {
          id: "histoire-muhammad-enfance",
          title: "Enfance et jeunesse de Muhammad ﷺ",
          description: "Naissance, orphelin, voyage en Syrie",
          duration: 35,
          difficulty: "advanced",
          emoji: "👶",
          isCompleted: false,
        ...
        {
          id: "histoire-muhammad-revelation",
          title: "La révélation et les premiers musulmans",
          description: "Première révélation, Khadija, premiers convertis",
          duration: 38,
          difficulty: "advanced",
          emoji: "📖",
          isCompleted: false,
        ...
        {
          id: "histoire-muhammad-mecque",
          title: "Période mecquoise",
          description: "Persécution, boycott, année de tristesse",
          duration: 40,
          difficulty: "advanced",
          emoji: "🕋",
          isCompleted: false,
        ...
        {
          id: "histoire-muhammad-hijra",
          title: "L'Hijra et Médine",
          description: "Migration, constitution de Médine, mosquée",
          duration: 32,
          difficulty: "advanced",
          emoji: "🏃",
          isCompleted: false,
        ...
        {
          id: "histoire-muhammad-batailles",
          title: "Les batailles majeures",
          description: "Badr, Uhud, Khandaq, conquête de La Mecque",
          duration: 45,
          difficulty: "advanced",
          emoji: "⚔️",
          isCompleted: false,
        ...
        {
          id: "histoire-muhammad-fin-vie",
          title: "Fin de vie et succession",
          description: "Pèlerinage d'adieu, dernier sermon, décès",
          duration: 30,
          difficulty: "advanced",
          emoji: "🕊️",
          isCompleted: false,
        ...
        {
          id: "histoire-califes-rashidun",
          title: "Les Califes Bien-Guidés",
          description: "Abu Bakr, Umar, Uthman, Ali - période complète",
          duration: 50,
          difficulty: "advanced",
          emoji: "👑",
          isCompleted: false,
        ...
        {
          id: "histoire-dynasties-islamiques",
          title: "Dynasties islamiques majeures",
          description: "Omeyyades, Abbassides, Ottomans selon Ibn Kathir",
          duration: 45,
          difficulty: "advanced",
          emoji: "🏛️",
          isCompleted: false,
