        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/subjects" className="text-slate-300 hover:text-white transition-colors">
                  Matières
                </Link>
              </li>
              <li>
                <Link href="/age-groups" className="text-slate-300 hover:text-white transition-colors">
                  Par âge
                </Link>
              </li>
              <li>
                <Link href="/activities" className="text-slate-300 hover:text-white transition-colors">
                  Activités
                </Link>
              </li>
              <li>
