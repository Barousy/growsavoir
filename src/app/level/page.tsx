        ...
        <section className="bg-gradient-to-br from-blue-50 via-white to-green-50 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Des activités et leçons adaptées à chaque niveau pour favoriser un bon développement            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-slate-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Pourquoi adapter le contenu aux niveaux ?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-slate-800">Développement cognitif</h3>
                <p className="text-slate-600">
                  Chaque niveau est basée sur les capacités spécifiques. Notre contenu respecte ces étapes.
                </p>
              </div>
              <div>
