...
export const metadata: Metadata = {
  title: 'Langue arabe - GrowSavoir',
  description: 'Apprenez l&apos;arabe classique et moderne avec nos leçons interactives.',
};
      ...
      <main className="pt-16">
        ...
        <section className="bg-gradient-to-br from-green-50 via-white to-green-100 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Découvrez la beauté de la langue arabe avec nos leçons structurées
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12">Nos leçons d&apos;arabe</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
                ...
                <h3 className="text-xl font-semibold mb-2">L&apos;alphabet arabe</h3>
                <p className="text-slate-600 mb-4">Les 28 lettres de l&apos;alphabet arabe</p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
                ...
                <p className="text-slate-600 mb-4">Marhaba, Ahlan, Sabah al-khair</p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-slate-500">Niveau: Débutant</span>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
                ...
                <h3 className="text-xl font-semibold mb-2">Les nombres</h3>
                <p className="text-slate-600 mb-4">Compter de 1 à 20 en arabe</p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-slate-500">Niveau: Débutant</span>
